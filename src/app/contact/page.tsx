            ...
            <div className="lg:col-span-5 space-y-8">
              ...
              <div className="space-y-6">
                {[
                  ...
                  { icon: <Mail className="w-5 h-5 text-[var(--color-brand-red)]" />, label: "Primary Email", val: "info@dtsindiapvtltd.com", link: "mailto:info@dtsindiapvtltd.com" },
                  { icon: <Mail className="w-5 h-5 text-[var(--color-brand-red)]" />, label: "Secondary Email", val: "dtsindiapvtltd1@gmail.com", link: "mailto:dtsindiapvtltd1@gmail.com" }
                ].map((item, idx) => (
