      ...
      <div className="hidden lg:block bg-[#1A1A1A] text-white/80">
        <div className="max-w-7xl mx-auto px-6 flex items-center justify-between h-8 text-xs tracking-wide">
          ...
          <div className="flex items-center divide-x divide-white/20">
            <a href="mailto:durgatransportservices2@gmail.com" className="pr-4 hover:text-white transition-colors">durgatransportservices2@gmail.com</a>
            <a href="tel:+919812773410" className="px-4 font-semibold hover:text-white transition-colors flex items-center gap-1.5">
              <Phone className="w-3 h-3" />
              +91 9812773410
            </a>
            <a href="tel:+919812773411" className="pl-4 font-semibold hover:text-white transition-colors flex items-center gap-1.5">
              <Phone className="w-3 h-3" />
              +91 9812773411
            </a>
          </div>
